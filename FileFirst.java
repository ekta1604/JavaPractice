...
public class FileFirst {
    public static void main(String[] args) throws IOException{
        ...
        File objDir = new File("e:\\File_Practice");
        File objFile1 = new File("e:\\File_practice\\Second\\Second.txt");
        File objFile = new File("e:\\File_Practice\\First.txt");
        File objDir2 = new File("e:\\File_practice\\Second");
        if (!objFile.exists()) {
